...
import (
	...
	v1beta1 "github.com/qualytics/spark-operator/pkg/apis/sparkoperator.k8s.io/v1beta1"
	v1beta2 "github.com/qualytics/spark-operator/pkg/apis/sparkoperator.k8s.io/v1beta2"
